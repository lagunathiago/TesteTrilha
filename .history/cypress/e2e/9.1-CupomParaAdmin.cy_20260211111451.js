...
describe("Teste - Login", () => {
  ...
  context("Fluxo análise financeira", () => {
    ...
    cy.get('.ng-scope > .bootstrap-datetime > .datetimepicker').should('be.visible').click(); // clicar no campo de data
    cy.get('[style="left: 354.793px; z-index: 2147483647; top: 127.481px;"] > .datetimepicker-days > .table-condensed > thead > :nth-child(1) > .next > .glyphicon').should('be.visible').click(); // clicar para avançar para o próximo mês
