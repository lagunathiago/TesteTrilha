...
describe("Teste - Login", () => {
    ...
    cy.get('ng-transclude > .column > :nth-child(1)').type('CupomTeste3'); //Nome do cupom
    ...
    cy.get('.ui-select-choices-row-inner > .ng-binding').click(); //Clica no treinamento selecionado
