...
describe("Teste - Login", () => {
    ...
    cy.get(':nth-child(4) > .w-100 > .ng-pristine').clear({ force: true }).type('1', { delay: 10, force: true }).should('have.value', '');

    cy.get('[switch="modal.coupons"] > .modal > :nth-child(2) > .modal-form > .end > .btn-swipe-accent').click(); //Clica em salvar
