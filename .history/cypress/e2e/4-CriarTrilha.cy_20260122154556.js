...
*/
    ...
    cy.wait(500); //espera para carregar o documento
    ...
    //TEM QUE CLICAR PRA ELE ESCREVER O NOME
    cy.get('[model="currentContent.evaluation"] > .multiselect > .border > .ui-select-match > .btn-default').type("teste"); //digitar nome do treinamento
    cy.wait(500); //espera para carregar o documento
    cy.get(".start > .btn-swipe-accent").click(); //adicionar documento
