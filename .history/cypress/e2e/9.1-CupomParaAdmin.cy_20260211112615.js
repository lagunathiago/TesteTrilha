...
describe("Teste - Login", () => {
  ...
  context("Fluxo análise financeira", () => {
    ...
    ccy.get('[style="left: 354.793px; z-index: 2147483647; top: 127.481px; display: block;"] > .datetimepicker-hours > .table-condensed > tbody > tr > td > :nth-child(9)').should('be.visible').click(); // clicar na hora 08
