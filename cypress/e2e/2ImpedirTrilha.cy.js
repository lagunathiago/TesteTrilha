...
it('Clica na Trilha e Faz Incrição', () => {
    ...
    //Clica na trilha
    cy.contains('.card-container', 'Impedir Conclusão Automação', { timeout: 60000 })
    .scrollIntoView()
    .should('be.visible')
    .click();
 ...
 it('Visualize os conteúdos do treinamento', () => {
  ...
  it('Verefica que não existe botão de finalizar', () => {

// Verifica que não existe botão/texto "Finalizar trilha"
cy.get('body', { timeout: 10000 })
  .should('not.contain.text', 'Finalizar trilha');

cy.log('✅ Automação foi concluída com sucesso');
