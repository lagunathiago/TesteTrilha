...
describe("Teste - Login", () => {
  ...
  it('Vai até a Categoria', () => {
   ...
   it('Criando Trilha Á vista com aprovação', () => {
...
const nomeTrilha = `Á vista com aprovação - Automação ${data}`;
...
cy.contains('.ui-select-choices-row', 'Usuario Automação', {timeout:60000})
  ...
  .click()
    ...
    cy.wait(6000)
       ...
       it('Criando Trilha Á vista sem aprovação', () => {
...
const nomeTrilha = `Á vista sem aprovação - Automação ${data}`;
...
cy.contains('.ui-select-choices-row', 'Usuario Automação', {timeout:60000})
  ...
  .click()
    ...
    cy.wait(6000)
       ...
       it('Criando Trilha Recorrente 2x com aprovação', () => {
...
const nomeTrilha = `Recorrente 2x com aprovação - Automação ${data}`;
...
cy.contains('.ui-select-choices-row', 'Usuario Automação', {timeout:60000})
  ...
  .click()
    ...
    cy.wait(6000)
           ...
           it('Criando Trilha Recorrente 2x sem aprovação', () => {
...
const nomeTrilha = `Recorrente 2x sem aprovação - Automação ${data}`;
...
cy.contains('.ui-select-choices-row', 'Usuario Automação', {timeout:60000})
  ...
  it('Criando Trilha Recorrente 5x com aprovação', () => {
...
const nomeTrilha = `Recorrente 5x com aprovação - Automação ${data}`;
...
//Clica em recorrência 
        cy.get('.checkbox.mt-20 > .icon-checkbox').click({ force: true });

        //Clica 3x para ficar a parcela em 5x
...
cy.contains('.ui-select-choices-row', 'Usuario Automação', {timeout:60000})
  ...
  .click()
    ...
    cy.wait(6000)
           ...
           it('Criando Trilha Recorrente 5x sem aprovação', () => {
...
const nomeTrilha = `Recorrente 5x sem aprovação - Automação ${data}`;
