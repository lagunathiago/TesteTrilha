...
describe("Teste - Login", () => {
  ...
  before(() => {
   ...
   it('Clica na Trilha e Faz Incrição e visualiza o documento', () => {

    cy.wait(3000)

    //Clica na trilha
    cy.contains('.card-container', 'Trilha Importada Sem Turma Automação', { timeout: 60000 })
    .scrollIntoView()
    .should('be.visible')
    .click();
...
it('Visualize o documento', () => {

    cy.wait(2000)

    //Clica em acessar no scorm
      cy.get(':nth-child(6) > .overflow-x > .stage-content-list > tbody > tr.ng-scope > :nth-child(6) > .pv-5 > .btn-swipe-accent')
    .should('be.visible')
    .click()
